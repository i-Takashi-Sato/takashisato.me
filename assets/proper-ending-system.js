(() => {
  ...
  if (ending && !reduce) {
    ...
    overlay.innerHTML = '<div class="pei-stop-card"><small>Circuit Breaker</small><h2>Process suspended.</h2><p>Meaningful judgment can no longer be verified. Reactivation requires an explicit human acknowledgement.</p><code>GDI threshold exceeded / semantic entropy rising / dissent channel exhausted / proper ending recorded</code><button type="button">Acknowledge and continue</button></div>';
