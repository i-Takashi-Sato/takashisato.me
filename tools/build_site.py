    ...
    write(
        ...
        utility_page(
            ...
            content=dedent(
                ...
                <section><h2>Architecture</h2><p>Every public page is pre-rendered static HTML from a small source model: canonical research metadata, document chrome, page renderers, source styles, and progressive-enhancement modules. Build output remains one shared stylesheet and one script; the stylesheet is preloaded and applied without an inline style block. There is no framework runtime, remote font request, client-side router, account system, or third-party UI package.</p></section>
                ...
                <section><h2>Build</h2><p>The site is generated by a dependency-free Python script and checked by a repository validator in continuous integration. Source architecture and public records reconciled on 23 September 2026.</p></section>
                """
            ).strip(),
        ),
    )
